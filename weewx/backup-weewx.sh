...
REMOTE_DIR="bosvoe@boshut:/usr/home/bosvoe/public_html/boshut.justobjects.nl/weewx/backup/"
...
rsync -e "ssh -p 222" -alzvx ${BCK_DIR} ${REMOTE_DIR} > ${WEEWX_HOME}/last-backup.log 2>&1
